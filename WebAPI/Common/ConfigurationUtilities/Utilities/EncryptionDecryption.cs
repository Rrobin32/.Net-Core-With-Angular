...
namespace ConfigurationUtilities.Utilities
{
    public class EncryptionDecryption
    {
        ...
        {
            var keybytes = Encoding.UTF8.GetBytes(ConstantValues.keyAesEncrDecr);
            var iv = Encoding.UTF8.GetBytes(ConstantValues.keyAesEncrDecr);

            var encryptedFromJavascript = EncryptStringToBytesAES(cipherText, keybytes, iv);
        ...
        public static string DecryptStringAES(string cipherText)
        {
            ...
            var decriptedFromJavascript = DecryptStringFromBytesAES(encrypted, keybytes, iv);
        ...
        #endregion AES Encryption / Decryption
    }
}
